              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-[var(--primary-color)] font-medium">{job.department}</p>
                  </div>
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-[var(--primary-color)] font-medium">{selectedJob.department} • {selectedJob.location}</p>
                </div>
                <button
                    ...
                    <ul className="space-y-2">
                      {selectedJob.responsibilities.map((responsibility, index) => (
                        <li key={index} className="flex items-start">
                          <svg className="w-4 h-4 text-[var(--primary-color)] mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
